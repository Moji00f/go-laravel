...
func TestUser_GetByEmail(t *testing.T) {
	u, err := models.Users.GetByEmail("moji@gmail.com")
	if err != nil {
		t.Error("failed to get user: ", err)
	}
...
func TestUser_Update(t *testing.T) {
	...
	err = u.Update(*u)
	if err != nil {
		t.Error("faile to update user: ", err)
	}

	u, err = models.Users.Get(1)
	if err != nil {
		t.Error("faile to get user: ", err)
	}

	if u.LastName != "Namdari" {
...
func TestToken_GenerateToken(t *testing.T) {
	...
	_, err = models.Tokens.GenerateToken(id, time.Hour*24*360)
	if err != nil {
...
func TestToken_Insert(t *testing.T) {
	...
	token, err := models.Tokens.GenerateToken(u.ID, time.Hour*24*360)
	if err != nil {
		t.Error("eeror generating token: ", err)
	}
...
func TestToken_GetUserForToken(t *testing.T) {
	...
	if err != nil {
		t.Error("faile to get user with valid token: ", err)
	}
}

func TestToken_GetTokenForUser(t *testing.T) {
...
var authData = []struct {
	...
	{"valid", "", "moji@gmail.com", false, "valid token reported as invalid"},
}
